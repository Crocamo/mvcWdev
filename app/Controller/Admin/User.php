...
class User extends Page
{
    ...
    public static function getUsers($request)
    {
        ...
        return parent::getPainel('Usuários > WDEV', $content, 'users');
    }
    ...
    public static function getNewUser($request)
    {
        ...
        //RETORNA A PÁGINA COMPLETA
        return parent::getPainel('Cadastrar usuário > WDEV', $content, 'users');
    }
    ...
    public static function getEditUser($request, $id)
    {
        ...
        //RETORNA A PÁGINA COMPLETA
        return parent::getPainel('Editar usuário > WDEV', $content, 'users');
    }
    ...
    public static function getDeleteUser($request, $id)
    {
        ...
        //RETORNA A PÁGINA COMPLETA
        return parent::getPainel('Excluir USUÁRIO > WDEV', $content, 'users');
    }
